#include "holberton.h"
/**
* print_error - When the command is not found, this function prints error.
* @argv: Double pointer containing tokens.
* @comando: First command passed to prompt.
* @count: Counts number of command.
*/
